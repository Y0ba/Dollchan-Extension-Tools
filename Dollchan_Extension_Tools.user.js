...
LngArray = {
	...
	disHidPview:	['Не отображать превью для скрытых постов', 'Don\'t display previews for hidden posts'],
...
function togglePost(post, vis) {
	...
	if(vis === 0) $Del('.//img[@class="DESU_preImg"]/ancestor::a', post.Msg);
	else addLinkImg(false, post);
}
